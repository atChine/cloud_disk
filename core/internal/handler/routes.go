	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				...
				Handler: MailCodeSandRegisterHandler(serverCtx),
			},
			{
				Method:  http.MethodPost,
				Path:    "/user/register",
			...
			{
				Method:  http.MethodGet,
				Path:    "/share/file/basic/detail",
				Handler: ShareFileBasicDetailHandler(serverCtx),
			},
		},
	)
	...
	server.AddRoutes(
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				{
					Method:  http.MethodPost,
					Path:    "/file/upload/chunk/end",
					Handler: FileUploadChunkEndHandler(serverCtx),
				},
			}...,
		),
	)
